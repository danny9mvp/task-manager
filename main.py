...
task_list = [Task(1, "Do my maths homework", "Solve some 2nd grade equations", "done"),
             Task(2, "Solve the tech test", "Submit the solution for the Python + SQL challenge for TCS", "pending")]
